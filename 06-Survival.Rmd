...
```{r CohortPlot, echo=FALSE,warning=FALSE,message=FALSE,error=FALSE, results='hide', fig.cap='True (blue) and estimated (black) annual survival rate using a cohort-based analysis of survey catch-at-age data.', out.width="90%"}
